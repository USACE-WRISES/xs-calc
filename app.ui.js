...
(function wireFilterModal(){
  ...
  if(openBtn){
    openBtn.addEventListener('click', (e)=>{
      ...
      const auto = document.getElementById('designerAutoApply');
      if(auto && auto.checked){
        alert('Turn off "Update XS Data" in the Designer tab before filtering.');
        return;
      }
      openModal();
    });
...
(function bankTools(){
  ...
  if(lbLeft)  lbLeft.addEventListener('click', (e)=>{ e.currentTarget.classList.add('clicked'); setTimeout(()=>e.currentTarget.classList.remove('clicked'),160); moveBank('LB', -1); });
  if(lbRight) lbRight.addEventListener('click', (e)=>{ e.currentTarget.classList.add('clicked'); setTimeout(()=>e.currentTarget.classList.remove('clicked'),160); moveBank('LB', +1); });
  if(rbLeft)  rbLeft.addEventListener('click', (e)=>{ e.currentTarget.classList.add('clicked'); setTimeout(()=>e.currentTarget.classList.remove('clicked'),160); moveBank('RB', -1); });
  if(rbRight) rbRight.addEventListener('click', (e)=>{ e.currentTarget.classList.add('clicked'); setTimeout(()=>e.currentTarget.classList.remove('clicked'),160); moveBank('RB', +1); });
